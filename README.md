...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-i5j0ls.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-i5j0ls.containers.anotherwebservice.com/
...
```
git clone git@github.com:12to12tech/container-i5j0ls.git
cd container-i5j0ls
```
...
```
docker attach container-i5j0ls
```
